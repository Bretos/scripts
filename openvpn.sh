#!/bin/bash
# OpenVPN installer, tested using Debian 6 & 7.
# should work on debian-based systems.
# script found somewhere online(if you know the author of the original code, let me know.)
# fixed up a bit by myself.
